...
// ─── Grid pattern (same as the-infinite-grid.tsx) ────────────────────────────
...
export default function ShaderShowcase() {
  ...
  return (
    ...
    >
      ...
      {/* Color orbs — same as the-infinite-grid */}
      ...
      {/* Content — same layout structure as the-infinite-grid */}
      <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-3xl mx-auto space-y-6 pointer-events-none">
        <div className="space-y-2">
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-foreground drop-shadow-sm">
            Launch AI Agents<br />Without Code
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground">
            Deploy, manage, and monitor intelligent agents on the Celo blockchain.<br />
        ...
        <div className="flex gap-4 pointer-events-auto">
          <Link href="/launch">
            <button className="px-8 py-3 bg-primary text-primary-foreground font-semibold rounded-md hover:bg-primary/90 transition-all shadow-md active:scale-95">
              Launch an Agent
            </button>
          </Link>
          <Link href="/dashboard">
